...
public class TC006_Aumento_Cupo_Rechazo {
	...
	public void Test() {
		...
		try {
			...
			estado = AumentoCupo.formAumentoCupoRechazo(excel.valorCol("Cupo", matriz), driver);
			if (!FunctionGeneric.stateStep("Fomulario Modificación de Cupo", estado, ITestCaseRun, wrapper)) {
				flagState = false;
				afterClass();
			}

			estado = FunctionGeneric.validarTexto("Fecha apertura", "Modificar Cupo", driver);
